...
class PlayerTwo():
    def getPlayerTwoMove(board, player2Letter, self):
    # Given a board and player2's letter, determine where to move and return that move.
    if player1Letter == 'X':
        player2Letter = 'O'
    else:
        player2Letter = 'X'
...
while True:
    ...
    while gameIsPlaying:
        if turn == 'player1':
            # Player1's turn.
            drawBoard(theBoard)
            move = p1.getPlayerOneMove(theBoard, player1Letter)
            ...
            # Player2's turn.
            move = p2.getPlayerTwoMove(theBoard, player2Letter)
